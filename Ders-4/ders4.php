...
<body>
    ...
    <ol>
        ...
        <li> Dizi içerisinde farklı türden birçok değer bulunabilir.(int, string, double,
         obje) (1,2,3"Ali","Ahmet","125,20")</li>
        <li>"echo $diziAdi" ile dizi içeriği ekrana yazdırılamaz. Arry to String Conversion 
        hatası verir. Fakat dizinin örneğin dizinin 3 indisine sahip elemanı "echo $diziAdiadi[3]" 
        şeklinde yazdırılabilir.</li>
        <li>Dizinin içerisndeki ifadeler çift tırnak("") içerisine yazılır.</li>
        <li>Dizinin içerisindeki int ifadeler direk yazılabilir.</li>
        <li>Dizinin elemanları birbirinden virgül (,) ile ayrılır </li>
        <li>Dizi içerisinde indisler varsayılan olarak 01dan başlar.</li>
        <li>Dizi içerisinde diziler tanımlanabilir.</li>
    </ol>
     ...
     echo "Dizinin 5.elemanın Türü:" . gettype($dizi1[3]) . "<br>";
     ...
     echo"<h4>Dizinin içeriğinin Foreach Döngüsü İle Yazdırılması-1 </h4>";
     foreach($dizi1 as $eleman) {
         echo "$eleman <br>";
     }

     echo"<h4>Dizinin içeriğinin Foreach Döngüsü İle Yazdırılması-2 </h4>";
    ...
    echo " $anahtar - $deger <br>";
     ...
     echo "Sayılar Dizisinin İçerisindeki İkinci Dizinin İkinci Elemanı: " . $sayilar2["Integer"][1]."<br>";
     echo "Sayılar Dizisinin İçerisindeki Birinci Dizinin Üçüncü Elemanı: " . $sayilar2["Double"][2]."<br>";
   ...
   echo "$bilgiler[adi]$bilgiler[sayadi]Hoşgeldiniz.<br>";
